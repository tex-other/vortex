...
%\section{Dummy Text}  %for performance tests
\vspace{.2in}
...
\subsection{Ordinary Text}  % Produces section heading.  Lower-level
...
\pagebreak
Glacial commands to generate them.  These characters include the
following: 
       \$ \& \% \# \{ and \}.
...
\end{itemize}
You can even display SOME poetry.
\begin{verse}
